...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_DonAINavigation_EDonNavigationQueryStatus()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("EDonNavigationQueryStatus::Unscheduled")), 0));
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("EDonNavigationQueryStatus::InProgress")), 1));
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("EDonNavigationQueryStatus::Success")), 2));
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("EDonNavigationQueryStatus::Failure")), 3));
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("EDonNavigationQueryStatus::QueryHasNoSolution")), 4));
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("EDonNavigationQueryStatus::TimedOut")), 5));
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("EDonNavigationQueryStatus::EDonNavigationQueryStatus_MAX")), 6));
	...
	uint32 Get_Z_Construct_UEnum_DonAINavigation_EDonNavigationQueryStatus_CRC() { return 552369125U; }
	...
	UScriptStruct* Z_Construct_UScriptStruct_FDoNNavigationQueryData()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_QueryStatus = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("QueryStatus"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(QueryStatus, FDoNNavigationQueryData), 0x0010000000000014, Z_Construct_UEnum_DonAINavigation_EDonNavigationQueryStatus());
	...
	uint32 Get_Z_Construct_UScriptStruct_FDoNNavigationQueryData_CRC() { return 2956745617U; }
